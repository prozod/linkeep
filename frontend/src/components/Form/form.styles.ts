export const formStyles = {
  defaults: ["p-6 flex justify-center flex-col w-[fit-content] bg-slate-800 rounded-lg"],
  labelandInputWrapper: ["relative z-0 w-full min-w-[20vw] mb-6 group flex items-center"],
  input: [
  ...
  headerWrapper: ["text-white text-center pb-6 pt-2"],
  headerTitle: ["font-bold"],
  headerParagraph: ["text-xs"],
  showPasswordButtonActive: [
    "absolute right-0 text-white text-[0.6rem] uppercase font-bold bg-red-500 px-1 rounded-sm hover:bg-red-600",
  ],
  showPasswordButtonInactive: [
    "absolute right-0 text-white text-[0.6rem] uppercase font-bold bg-indigo-500 px-1 rounded-sm hover:bg-indigo-600",
  ],
};
